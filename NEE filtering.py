...
def GetECFileNames(season):
        ...
        if season == 'Gadash 2019':
            ...
            # EC data filename (full_output file)
            full_output_filename = 'eddypro_all_full_output_2024-09-10T161657_exp'
            # Biomet data filename
...
def GetSpikeDetectionIndices(inds):
...
def CalcSaveInds(season,EC_table,biomet_table,meteo,path):
    ...
    inds['spike_detection'] = GetSpikeDetectionIndices(inds)
...
if __name__ == "__main__":
    ...
    ## Run the R script
    # r_script_path = r'C:\PhD\Codes python\EC analysis\Reddyproc\NEE_u_star_gap_filling.R'
    
    # subprocess.call(['Rscript', r_script_path], shell=True)
